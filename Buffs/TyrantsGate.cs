...
{
    public class TyrantsGate : ModBuff
    {
        public override void SetDefaults()
        {
            Main.buffNoTimeDisplay[Type] = false;
            DisplayName.SetDefault("Tyrant's Gate");
            Description.SetDefault("Increases throwing damage by 25%");
        ...
        {
            player.GetModPlayer<MyPlayer>(mod).Tyrant = true;
        }
    }
}