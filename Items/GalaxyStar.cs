...
{
    public class GalaxyStar : ModItem
    {
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(null, ("StarCrystal"), 25);
        ...
        public override void SetStaticDefaults()
        {
            ...
            Tooltip.SetDefault("Increases max mana by 100");
        }
        public override bool CanUseItem(Player player)
        {
            return ((MyPlayer)player.GetModPlayer(mod, "MyPlayer")).bonusMana <= 99;
        }
        public override bool UseItem(Player player)
        {
            ((MyPlayer)player.GetModPlayer(mod, "MyPlayer")).bonusMana += 100;
            int num3 = 0;
