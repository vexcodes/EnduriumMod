...
{
    public class GraniteMarbleBoomerangMelee : ModItem
    {
		...
		item.shoot = mod.ProjectileType("GraniteMarbleBoomerangMelee");
						    ...
						    public override void MeleeEffects(Player player, Rectangle hitbox)
    {
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(null, ("GraniteBoomerangMelee"));
			            recipe.AddIngredient(null, ("MarbleBomerangMelee"));
