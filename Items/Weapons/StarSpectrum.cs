...
{
    public class StarSpectrum : ModItem
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            Tooltip.SetDefault("Fires star bolts\nUpon contact reduces enemy defense");
        }
		        public override bool Shoot(Player player, ref Microsoft.Xna.Framework.Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
        {
            ...
            for (int num108 = 0; num108 < num107; num108++)
            {
                ...
                int projectile = Projectile.NewProjectile(vector2.X, vector2.Y, speedX4, speedY5, mod.ProjectileType("StarSpectrum"), num73, num74, i, 0f, (float)Main.rand.Next(25));
            }
            return true;
        }
    }
