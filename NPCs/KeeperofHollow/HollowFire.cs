...
{
    public class HollowFire : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                Projectile.NewProjectile((float)num414, (float)num415, 0f, -Speed, mod.ProjectileType("HollowMist"), 25, 0f, Main.myPlayer, 0f, 0f);
            }
            if (projectile.ai[1] == 30)
            {
                Projectile.NewProjectile((float)num414, (float)num415, -Speed, -Speed, mod.ProjectileType("HollowMist"), 25, 0f, Main.myPlayer, 0f, 0f);
            }
            if (projectile.ai[1] == 45)
            {
                Projectile.NewProjectile((float)num414, (float)num415, -Speed, 0f, mod.ProjectileType("HollowMist"), 25, 0f, Main.myPlayer, 0f, 0f);
            }
