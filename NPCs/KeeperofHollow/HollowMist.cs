...
{
    public class HollowMist : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            {
                int num624 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, mod.DustType("HollowBurn"), 0f, 0f, 100, default(Color), 1.7f);
