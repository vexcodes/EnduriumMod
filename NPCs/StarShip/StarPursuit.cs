...
{
    public class StarPursuit : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Star Pursuit");
        }
        ...
        public override void Kill(int timeLeft)
        {
            ...
            Projectile.NewProjectile((float)num414, (float)num415, 0f, 0f, mod.ProjectileType("StarEruptionSingular"), projectile.damage, 0f, Main.myPlayer);
