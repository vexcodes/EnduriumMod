...
namespace EnduriumMod.NPCs.TheSwarm
{
    public class EarthElemental : ModNPC
    {
        ...
        {
            DisplayName.SetDefault("The Earthen Crystal");
        }
        ...
        public override void AI()
        {
            ...
            {
                int num294 = Dust.NewDust(npc.position, npc.width, npc.height, 2, 0f, 0f, 200, default(Color), 1f);
            ...
            if (npc.direction < 0)
            {
                npc.rotation = (float)Math.Atan2(-(double)num297, -(double)num296);
            }
            else
            {
                npc.rotation = (float)Math.Atan2((double)num297, (double)num296);
            ...
            {
                int num299 = 21;
                int num300 = mod.ProjectileType("EarthFragment");
