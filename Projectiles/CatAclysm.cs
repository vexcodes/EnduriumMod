...
{
    public class CatAclysm : ModProjectile
    {
        ...
        {
            DisplayName.SetDefault("Cat-Aclysm");
        }
        ...
        public override bool PreAI()
        {
            ...
            for (int num20 = 0; num20 < 4; num20 = num3 + 1)
            {
                ...
                int num23 = Dust.NewDust(projectile.position, projectile.width, projectile.height, 176, 0f, 0f, 0, default(Color), 1f);
            ...
            for (int num20 = 0; num20 < 4; num20 = num3 + 1)
            {
                float num21 = projectile.velocity.X / 4f * (float)num20;
                float num22 = projectile.velocity.Y / 4f * (float)num20;
                int num23 = Dust.NewDust(projectile.position, projectile.width, projectile.height, 180, 0f, 0f, 0, default(Color), 1f);
                Main.dust[num23].position.X = projectile.Center.X - num21;
                Main.dust[num23].position.Y = projectile.Center.Y - num22;
                Dust dust3 = Main.dust[num23];
                dust3.velocity *= 0f;
