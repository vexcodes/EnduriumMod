    ...
    public class EyeMinion : ModProjectile
    {
        ...
        public override void AI()
        {
            int num3;
            {
                ...
                player.AddBuff(mod.BuffType("Eye"), 3600);
                if (player.dead)
                {
                    modPlayer.Eye = false;
                }
                ...
                {
                    projectile.ai[1] += (float)Main.rand.Next(1, 8);
                }
                if (projectile.ai[1] > 0f && projectile.ai[1] < 11f)
                {
                    projectile.ai[1] += 1;
                }
                if (projectile.ai[1] > 455f)
                {
                    projectile.ai[1] = 0f;
                    projectile.netUpdate = true;
                }
                ...
                if (projectile.ai[0] == 0f)
                {
                    ...
                    int num29 = mod.ProjectileType("BloodTissue");
                    if (flag)
                    {

                        if (projectile.ai[1] == 0f || projectile.ai[1] == 10f)
                        {
