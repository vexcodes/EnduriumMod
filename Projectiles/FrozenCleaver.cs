...
{
    public class FrozenCleaver : ModProjectile
    {
        ...
        public override bool PreAI()
        {
            if (projectile.ai[0] == 0)
            {
                ...
                {
                    int num732 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 156, 0f, 0f, 100, default(Color), 1.5f);
                    Main.dust[num732].noGravity = true;
                    Dust dust = Main.dust[num732];
                    dust.velocity *= 2f;
                    num732 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 132, 0f, 0f, 100, default(Color), 0.5f);
            ...
            if (projectile.alpha < 170)
            {
                ...
                for (int num164 = 0; num164 < 2; num164 = num + 1)
                {
                    ...
                    int num165 = Dust.NewDust(new Vector2(x2, y2), projectile.width, projectile.height, 132, 0f, 0f, 0, default(Color), 1f);
