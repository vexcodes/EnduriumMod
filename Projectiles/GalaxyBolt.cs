...
{
    public class GalaxyBolt : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Galaxy Bolt");
        }
        ...
        public override void AI()
        {
            ...
            for (int num452 = 0; num452 < 4; num452 = num3 + 1)
            {
                ...
                int num453 = Dust.NewDust(vector36, 1, 1, 56, 0f, 0f, 0, new Color(Main.DiscoR, Main.DiscoG, Main.DiscoB), 0.9f);
