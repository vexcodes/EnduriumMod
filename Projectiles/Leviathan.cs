...
{
    public class Leviathan : ModProjectile
    {
        ...
        public override bool PreAI()
        {
            for (int num136 = 0; num136 < 3; num136++)
            {
                ...
                int num137 = Dust.NewDust(new Vector2(x2, y2), 16, 255, 157, 0f, 0f, 0, default(Color), 0.62f);
        ...
        public override void Kill(int timeLeft)
        {
            for (int k = 0; k < 5; k++)
            {
                Dust.NewDust(projectile.position + projectile.velocity, projectile.width, projectile.height, 157, projectile.oldVelocity.X * 0f, projectile.oldVelocity.Y * 0f);
            }
        }
