...
{
    public class MushroomHammer : ModProjectile
    {
        ...
        {
            DisplayName.SetDefault("Gleam Hammer");
        }
        public override void AI()
        {
            int a = Dust.NewDust(projectile.position + projectile.velocity, projectile.width, projectile.height, 15, projectile.velocity.X * 0.5f, projectile.velocity.Y * 0.5f);
            projectile.ai[0] += 1f;
