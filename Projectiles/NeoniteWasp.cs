...
{
    public class NeoniteWasp : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (projectile.ai[0] == 0f)
            {
                ...
                int num29 = mod.ProjectileType("NeonFire");
                if (flag)
                {
                    ...
                    if (projectile.ai[1] == 0f)
                    {
                        ...
                        if (Main.myPlayer == projectile.owner)
                        {
                            ...
                            int num33 = Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, vector10.X, vector10.Y, num29, 140, 0f, Main.myPlayer, 0f, 0f);
