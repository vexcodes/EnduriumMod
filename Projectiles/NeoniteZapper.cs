...
{
    public class NeoniteZapper : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Neonite Zapper");
        }
        ...
        public override void AI()
        {
            ...
            for (int num93 = 0; num93 < 5; num93 = num3 + 1)
            {
                ...
                int num96 = 4;
                int num97 = Dust.NewDust(new Vector2(projectile.position.X + (float)num96, projectile.position.Y + (float)num96), projectile.width - num96 * 2, projectile.height - num96 * 2, 27, 0f, 0f, 100, default(Color), 0.45f);
