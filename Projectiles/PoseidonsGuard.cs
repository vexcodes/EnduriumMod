...
{
    public class PoseidonsGuard : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Poseidon's Guard");
        }
        ...
        {
            {
                ...
                player.AddBuff(mod.BuffType("PoseidonsGuard"), 3600);
                if (player.dead)
                {
                    modPlayer.PoseidonsGuard = false;
                }
                ...
                {
                    projectile.ai[1] += (float)Main.rand.Next(1, 10);
                }
                if (projectile.ai[1] > 400f)
                {
                    projectile.ai[1] = 0f;
                    projectile.netUpdate = true;
                }
                ...
                if (projectile.ai[0] == 0f)
                {
                    ...
                    int num29 = mod.ProjectileType("SeaTrident");
                    if (flag)
                    {
