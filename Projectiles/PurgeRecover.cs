...
{
    public class PurgeRecover : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Purge Recover");
        }
        ...
        public override void Kill(int timeLeft)
        {
            ...
            {
                int num = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 173, 0f, 0f, 100, default(Color), 1.2f);
        ...
        public override void AI()
        {
            ...
            for (int num93 = 0; num93 < 1; num93 = num4 + 1)
            {
                ...
                int num96 = 4;
                int num97 = Dust.NewDust(new Vector2(projectile.position.X + (float)num96, projectile.position.Y + (float)num96), projectile.width - num96 * 2, projectile.height - num96 * 2, 173, 0f, 0f, 100, default(Color), 1f);
            ...
            {
                projectile.ai[1] = 2 + Main.rand.Next(1, 4);
            }
