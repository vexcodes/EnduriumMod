...
namespace EnduriumMod.Projectiles
{
    public class RosyBlast : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            int num96 = 4;
            int num97 = Dust.NewDust(new Vector2(projectile.position.X + (float)num96, projectile.position.Y + (float)num96), projectile.width - num96 * 2, projectile.height - num96 * 2, 35, 0f, 0f, 100, default(Color), 1.1f);
