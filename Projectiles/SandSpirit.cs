...
{
    public class SandSpirit : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Sand Spirit");
        }
        ...
        {
            {
                ...
                player.AddBuff(mod.BuffType("SandSentry"), 3600);
                if (player.dead)
                {
                    modPlayer.SandSentry = false;
                }
                ...
                if (projectile.ai[0] == 0f)
                {
                    ...
                    int num29 = mod.ProjectileType("SandWave");
                    if (flag)
                    {
