...
{
    public class SpaceMinion : ModProjectile
    {
        ...
        {
            {
                ...
                player.AddBuff(mod.BuffType("SpaceMinionBuff"), 3600);
                if (player.dead)
                {
                    modPlayer.SpaceMinionBuff = false;
                }
                ...
                if (projectile.ai[0] == 0f)
                {
                    ...
                    int num29 = mod.ProjectileType("SpaceFire");
                    if (flag)
                    {
                        ...
                        if (projectile.ai[1] == 0f)
                        {
                            ...
                            if (Main.myPlayer == projectile.owner)
                            {
                                ...
                                int num33 = Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, vector10.X, vector10.Y, num29, 24, 0f, Main.myPlayer, 0f, 0f);
