...
{
    public class StarFallArcanum2 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            for (int num20 = 0; num20 < 4; num20 = num4324 + 1)
            {
                ...
                int num23 = Dust.NewDust(projectile.position, projectile.width, projectile.height, 156, 0f, 0f, 0, default(Color), 0.58f);
