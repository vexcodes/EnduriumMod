...
{
    public class TrueHeavenRupture : ModProjectile
    {
        ...
        {
            DisplayName.SetDefault("True Heaven Rupture");
        }
        ...
        public override void AI()
        {
            ...
            if (projectile.localAI[0] == 16f)
            {
                ...
                for (int l = 0; l < 12; l = num + 1)
                {
                    ...
                    Main.dust[num9].velocity = projectile.velocity * 0.4f;
                    Main.dust[num9].velocity = Vector2.Normalize(projectile.Center - projectile.velocity * 4f - Main.dust[num9].position) * 1.4f;
                    num = l;
                }
            }
        }
