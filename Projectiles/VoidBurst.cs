...
namespace EnduriumMod.Projectiles
{
    public class VoidBurst : ModProjectile
    {
        ...
        {
            DisplayName.SetDefault("Void Burst");
        }
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int num20 = 0; num20 < 1; num20 = num3 + 1)
            {
                ...
                int num23 = Dust.NewDust(projectile.position, projectile.width, projectile.height, 14, 0f, 0f, 0, default(Color), 1.3f);
            ...
            for (int num20 = 0; num20 < 1; num20 = num3 + 1)
            {
                float num21 = projectile.velocity.X / 4f * (float)num20;
                float num22 = projectile.velocity.Y / 4f * (float)num20;
                int num23 = Dust.NewDust(projectile.position, projectile.width, projectile.height, 70, 0f, 0f, 0, default(Color), 1.3f);
                Main.dust[num23].position.X = projectile.Center.X - num21;
                Main.dust[num23].position.Y = projectile.Center.Y - num22;
                Dust dust3 = Main.dust[num23];
        ...
        public override void AI()
        {
            ...
            for (int num452 = 0; num452 < 1; num452 = num3 + 1)
            {
                ...
                int num453 = Dust.NewDust(vector36, 1, 1, 70, 0f, 0f, 0, default(Color), 1f);
            ...
            for (int num452 = 0; num452 < 1; num452 = num3 + 1)
            {
                ...
                vector36 -= projectile.velocity * ((float)num452 * 0.25f);
                projectile.alpha = 255;
                int num453 = Dust.NewDust(vector36, 1, 1, 255, 0f, 0f, 0, default(Color), 1f);
                Main.dust[num453].position = vector36;
                Dust dust3 = Main.dust[num453];
                dust3.velocity *= 0f;
                dust3.noGravity = true;
