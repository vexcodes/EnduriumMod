...
namespace EnduriumMod.Tiles.ForestFly
{
    class TropicalCandle : ModTile
    {
        public override void SetDefaults()
        {
            ...
            name.SetDefault("Trapped Tropic Firefly");
            AddMapEntry(new Color(0, 115, 25), name);
        ...
        {
            Item.NewItem(i * 16, j * 16, 16, 32, mod.ItemType("TropicalCandle"));
        }
    }
}
