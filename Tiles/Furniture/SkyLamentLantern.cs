...
{
	class SkyLamentLantern : ModTile
	{
		public override void SetDefaults()
		{
			...
			name.SetDefault("Sky Glaze Lantern");
			AddMapEntry(new Color(138, 145, 205), name);
		...
		{
			Item.NewItem(i * 16, j * 16, 16, 32, mod.ItemType("SkyLamentLantern"));
		}
	}
}
